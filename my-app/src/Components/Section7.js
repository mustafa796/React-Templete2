                        ...
                        <div className="col-lg-4 col-md-6 col-12 mb-5 mb-lg-0">
                            <div className="pricing-thumb bg-white shadow-lg">                                
                                <div className="pricing-title-wrap d-flex align-items-center">
                                    ...
                                    <h5 className="pricing-small-title text-white mb-0 ms-auto">$640</h5>
                                </div>
                                ...
                                <div className="pricing-body">
                                    ...
                                    <a className="custom-btn btn mt-3" href="#">Buy Tickets</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-12 mb-5 mb-lg-0">
                            <div className="pricing-thumb bg-white shadow-lg">                                
                                <div className="pricing-title-wrap d-flex align-items-center">
                                    ...
                                    <h5 className="pricing-small-title text-white mb-0 ms-auto">$840</h5>
                                </div>
                                ...
                                <div className="pricing-body">
                                    ...
                                    <p>
                                        <i className="bi-boombox me-2"></i> Group Meetings + After Party
                                    </p>

                                    <p>
                                        <i className="bi-chat-square me-2"></i> 24/7 Support + Instant Chats
                                    </p>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div className="pricing-thumb bg-white shadow-lg">                                
                                <div className="pricing-title-wrap d-flex align-items-center">
                                    ...
                                    <h5 className="pricing-small-title text-white mb-0 ms-auto">$1,240</h5>
                                </div>
                                ...
                                <div className="pricing-body">
                                    ...
                                    <p>
                                        <i className="bi-boombox me-2"></i> Private Meetings + After Party
                                    </p>
