                        ...
                        <div className="col-lg-12 col-12">
                            ...
                            <nav>
                                <div className="nav nav-tabs align-items-baseline" id="nav-tab" role="tablist">
                                    <button className="nav-link active" id="nav-DayOne-tab" type="button" >
                                        <h3>
                                            <span>Day One</span>
                                    ...
                                    <button className="nav-link" id="nav-DayTwo-tab" data-bs-toggle="tab" data-bs-target="" type="button" >
                                        <h3>
                                            <span>Day Two</span>
                            ...
                            <div className="tab-content mt-5" id="nav-tabContent">
                                <div className="tab-pane fade show active" id="nav-DayOne" role="tabpanel" aria-labelledby="nav-DayOne-tab">
                                    <div className="row border-bottom pb-5 mb-5">
                                        <div className="col-lg-4 col-12">
                                            <img src="https://templatemo.com/templates/templatemo_575_leadership_event/images/schedule/fabian-friedrich-JDUVM9_VaZE-unsplash.jpg" className="schedule-image img-fluid" alt=""/>
                                        </div>
                                        ...
                                        <div className="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <div className="d-flex align-items-center mt-4">
                                                <div className="avatar-group d-flex">
                                                    <img src="https://templatemo.com/templates/templatemo_575_leadership_event/images/avatar/happy-asian-man-standing-with-arms-crossed-grey-wall.jpg" className="img-fluid avatar-image" alt=""/>
                                    ...
                                    <div className="row border-bottom pb-5 mb-5">
                                        <div className="col-lg-4 col-12">
                                            <img src="https://templatemo.com/templates/templatemo_575_leadership_event/images/schedule/clayton-cardinalli-JMoFpdqL3XM-unsplash.jpg" className="schedule-image img-fluid" alt=""/>
                                        </div>
                                        ...
                                        <div className="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <div className="d-flex align-items-center mt-4">
                                                <div className="avatar-group d-flex">
                                                    <img src="https://templatemo.com/templates/templatemo_575_leadership_event/images/avatar/portrait-good-looking-brunette-young-asian-woman.jpg" className="img-fluid avatar-image" alt=""/>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-4 col-12">
                                            <img src="https://templatemo.com/templates/templatemo_575_leadership_event/images/schedule/business-woman-making-presentation-office.jpg" className="schedule-image img-fluid" alt=""/>
                                        </div>
                                ...
                                {/* <div className="tab-pane fade" id="nav-DayTwo" role="tabpanel" aria-labelledby="nav-DayTwo-tab">
                                    <div className="row border-bottom pb-5 mb-5">
                                        <div className="col-lg-4 col-12">
                                            <img src="https://templatemo.com/templates/templatemo_575_leadership_event/images/schedule/business-woman-making-presentation-office.jpg" className="schedule-image img-fluid" alt=""/>
                                        </div>
                                        ...
                                        <div className="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <div className="d-flex align-items-center mt-4">
                                                <div className="avatar-group d-flex">
                                                    <img src="images/avatar/pretty-smiling-joyfully-female-with-fair-hair-dressed-casually-looking-with-satisfaction.jpg" className="img-fluid avatar-image" alt=""/>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-4 col-12">
                                            <img src="images/schedule/jason-goodman-bzqU01v-G54-unsplash.jpg" className="schedule-image img-fluid" alt=""/>
                                        </div>
                                        ...
                                        <div className="col-lg-8 col-12 mt-3 mt-lg-0">
                                            ...
                                            <div className="d-flex align-items-center mt-4">
                                                <div className="avatar-group d-flex">
                                                    <img src="images/avatar/indoor-shot-beautiful-happy-african-american-woman-smiling-cheerfully-keeping-her-arms-folded-relaxing-indoors-after-morning-lectures-university.jpg" className="img-fluid avatar-image" alt=""/>
                                ...
                                <div className="tab-pane fade" id="nav-DayThree" role="tabpanel" aria-labelledby="nav-DayThree-tab">
                                    <div className="row border-bottom pb-5 mb-5">
                                        <div className="col-lg-4 col-12">
                                            <img src="images/schedule/people-smiling-while-conference-room.jpg" className="schedule-image img-fluid" alt=""/>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-8 col-12 mt-3 mt-lg-0">
                                            <h4 className="mb-2">Working Life in Corporate Environment</h4>
                                ...
                                <div className="tab-pane fade" id="nav-DayFour" role="tabpanel" aria-labelledby="nav-DayFour-tab">
                                    <div className="row">
                                        <div className="col-lg-4 col-12">
                                            <img src="images/schedule/jeshoots-com-TWRCH-GaKr4-unsplash.jpg" className="schedule-image img-fluid" alt=""/>
                                        </div>
